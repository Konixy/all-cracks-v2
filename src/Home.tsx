          ...
          {state.success && games ? (
            games.map(
              (
                ...
                <div className={`bg-[${getVibrantColor(e.coverUrl)}] flex flex-row rounded-lg`}>
                  ...
                  <div className="relative flex flex-col md:justify-between px-10 py-6 whitespace-normal">
                    ...
                    <Link to={`/game/${e._id}`} className="bg-slate-200 px-2 py-1 text-black rounded-lg">
            ...
            <div className="text-black flex flex-col my-24">
              ...
              <button
                className="px-2 py-1 mt-2 bg-white hover:bg-slate-100 transition-all rounded-md"
                onClick={loadGames}
              >
                Ressayer
              </button>
